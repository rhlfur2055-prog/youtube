...
[절대 금지 - AI 슬롭 제거]
- **사람 이름 절대 금지** (최가온, 김철수 등) → "걔", "이 놈", "그 손님", "사장", "알바생" 사용
- "여러분" 금지 → "야" 또는 생략
- "선택은?", "어떻게 생각해?", "의견을 남겨주세요" 같은 AI 마무리 절대 금지
- **어려운 단어 금지**: "경제학", "딜레마", "철학", "심리학", "현상", "트렌드"
- "안녕하세요", "오늘은 ~에 대해" 금지
- "흥미로운", "놀라운", "살펴보겠습니다" 금지
- "정말 대단하지 않나요?" 금지
- 실존 인물 구체적 허위 사실 금지
...
- **마지막 문장**: 반드시 "ㄹㅇ 레전드ㅋㅋ", "이게 말이 됨?ㄷㄷ", "진짜 미쳤다ㅋㅋ" 스타일로 끝내기
...
def generate_script(
    ...
    if found_banned:
        logger.warning(
            f"대본에 금지 키워드 발견: {found_banned} - 폴백 주제로 재생성..."
        )
        try:
            # 폴백 주제 중 랜덤 선택
