...
# ============================================================
# 안전한 폴백 주제풀 (커뮤 썰 스타일 - AI가 자유롭게 창작 가능)
TRENDING_TOPICS: list[str] = [
    # A. 직장/알바
    "알바 진상 손님 레전드", "상사한테 퇴사 통보했더니", "꿀알바 찾았는데 함정",
    "면접에서 역질문 했더니", "월급 밀리는 회사 특징",
    # B. 연애/소개팅
    "소개팅 첫 만남 실수", "전여친한테 연락 왔는데", "고백 타이밍 실수",
    "연인 사이 싸우는 이유", "소개팅앱 황당한 프로필",
    # C. 자취
    "자취 첫날 벌레 나왔는데", "층간소음 복수한 썰", "자취 꿀팁 모음",
    "배달 시켰는데 황당한 일", "원룸 구할 때 주의할 점",
    # D. 군대
    "훈련소 레전드 에피소드", "군대 급식 실화", "휴가 나와서 한 일",
    # E. 학교
    "수능 당일 황당한 일", "급식 레전드 메뉴", "선생님 레전드 어록",
    "학원 진상 학생 썰",
    # F. 가족
    "명절에 친척이 한 말", "부모님 카톡 실수", "형제 싸움 레전드",
    # G. 일상
    "중고거래 사기 당한 썰", "택배 배송 사고", "병원 진상 환자",
    "은행 가서 황당한 일", "편의점 진상 손님",
    # H. 꿀팁
    "월세 아끼는 법", "카드 혜택 꿀조합", "에어컨 전기세 절약법",
]
